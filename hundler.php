...
if($_POST['more_f'])
{
  if($_POST['more_number'] == '1')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            при закрытии или открытии задевает очень сильно или имеется еще какая-либо неисправность.
            ...
            <form>
              ...
              <button type="submit">Обратиться к эксперту</button>
            </form>
          </div>');
  }
  if($_POST['more_number'] == '2')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/2.png" alt="Устранение продуваний">
  ...
  if($_POST['more_number'] == '3')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/3.png" alt="Устранение продуваний">
  ...
  if($_POST['more_number'] == '4')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/4.png" alt="Наружные откосы и отливы (металл)">
  ...
  if($_POST['more_number'] == '5')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/5.png" alt="Наружные откосы и отливы (металл)">
  ...
  if($_POST['more_number'] == '6')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/6.png" alt="Устранение запотевания">
  ...
  if($_POST['more_number'] == '7')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            <h2>Подоконники</h2>
            <img src="img/more/7.png" alt="Подоконники">
  ...
  if($_POST['more_number'] == '8')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/8.png" alt="Установка детских замков">
  ...
  if($_POST['more_number'] == '9')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            <h2>Жалюзи</h2>
            <img src="img/more/9.png" alt="Жалюзи">
  ...
  if($_POST['more_number'] == '10')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/10.png" alt="Москитные сетки (ремонт и установка)">
  ...
  if($_POST['more_number'] == '11')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/11.png" alt="Производство и монтаж новых окон">
  ...
  if($_POST['more_number'] == '12')
  {
    exit('<div class="modal-header">
          ...
          <div class="modal-body text-center">
            ...
            <img src="img/more/12.png" alt="Тонировка окон и балконов">
